...
class CalendarScheduleSeeder extends Seeder
{
    public function run()
    {
        $events = [
            ...
            ['date' => '2025-03-20', 'type' => 'Event', 'title' => 'Spring Equinox', 'time' => '15:30 - 16:30', 'location' => 'Courtyard', 'description' => 'Team building activity to welcome spring.'],
            ['date' => '2025-03-25', 'type' => 'Meeting', 'title' => 'Project Review', 'time' => '11:00 - 12:00', 'location' => 'Conference Room B', 'description' => 'Quarterly review of ongoing projects.'],
            ...
            ['date' => '2025-03-20', 'type' => 'Meeting', 'title' => 'Department Sync', 'time' => '09:30 - 10:30', 'location' => 'Conference Room C', 'description' => 'Sync meeting with department heads.'],
            ['date' => '2025-03-20', 'type' => 'Meeting', 'title' => 'Department Sync', 'time' => '09:30 - 10:30', 'location' => 'Conference Room C', 'description' => 'Sync meeting with department heads.'],
            ['date' => '2025-03-20', 'type' => 'Meeting', 'title' => 'Department Sync', 'time' => '09:30 - 10:30', 'location' => 'Conference Room C', 'description' => 'Sync meeting with department heads.'],
            ['date' => '2025-03-20', 'type' => 'Holiday', 'title' => 'Department Sync', 'time' => '09:30 - 10:30', 'location' => 'Conference Room C', 'description' => 'Sync meeting with department heads.'],
