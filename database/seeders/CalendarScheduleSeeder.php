...
class CalendarScheduleSeeder extends Seeder
{
    public function run()
    {
        $events = [
            ...
            ['date' => '2025-03-28', 'type' => 'Wellness', 'title' => 'Department Sync1', 'time' => '09:30 - 10:30', 'location' => 'Conference Room C', 'description' => 'Sync meeting with department heads.'],
            ['date' => '2025-03-28', 'type' => 'Holiday', 'title' => 'Department Sync2', 'time' => '09:30 - 10:30', 'location' => 'Conference Room C', 'description' => 'Sync meeting with department heads.'],
            ['date' => '2025-03-28', 'type' => 'Meeting', 'title' => 'Department Sync3', 'time' => '09:30 - 10:30', 'location' => 'Conference Room C', 'description' => 'Sync meeting with department heads.'],
            ['date' => '2025-03-28', 'type' => 'Event', 'title' => 'Department Sync4', 'time' => '09:30 - 10:30', 'location' => 'Conference Room C', 'description' => 'Sync meeting with department heads.'],
