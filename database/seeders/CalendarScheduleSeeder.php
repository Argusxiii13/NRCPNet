...
class CalendarScheduleSeeder extends Seeder
{
    public function run()
    {
        $events = [
            ...
            ['date' => '2025-05-01', 'type' => 'Wellness', 'title' => 'Spring Equinox', 'time' => '15:00 - 17:00', 'location' => 'Courtyard', 'description' => 'Team building activity to welcome spring.'],
            ['date' => '2025-04-25', 'type' => 'Meeting', 'title' => 'Project Review', 'time' => '11:00 - 12:00', 'location' => 'Conference Room B', 'description' => 'Quarterly review of ongoing projects.'],
